      ...
      <div class="box-1">
                ...
                <b-row style="margin-top:5px;" >
                  ...
                  <b-col  xl>
                    <div style="margin:0 0 15px 0;"  class="md-layout">
                      <div style="padding:0 30px 0 0;width:auto" class="head">ประเภทผู้ใช้</div>
        ...
        <div v-if="statusInput === 'admin' ">
          ...
          <b-row>
            <b-col xl>
                        <div  class="md-layout">
                          <div class="head">Admin ID <span style="color:red">*</span></div>
                          <div class="detail" style="">
                            <input 
                              v-model="admin.ID"
                          ...
                          <div class="detail" style="">
                            <input 
                             v-bind:class="[Error.errorClassCompany]"
                              ...
                              style="background: #fff;"
                            class="input-style">
                             <div v-if="this.Error.errorClassCompany != ''"  class="txt-wrong">
                              <span class="mdi mdi-alert-octagon"></span>
                        ...
                        <div  class="md-layout">
                          ...
                          <div class="detail" style="">
                             <v-select
                                ...
                                :item-text="item => item.name_th"
                                :item-value="item => item"
                                :disabled="select_province.subdistrict == '' ? true : false"
                                solo
                                dense
                        ></v-select>
                          </div>
          ...
          <b-row >
            ...
            <b-col>
               <div  class="md-layout">
                <div class="head"></div>
                <div class="detail" style="dwidth:100%;display: flex;justify-content: flex-end;">
                  <div  @click="cancel" style="font-weight: 600;cursor: pointer;;padding:0 30px 0 0;display: flex;align-items: center;">ยกเลิก</div>
                  <v-btn style="border-radius: 8px;"  rounded class="ok" @click="openDialog()">บันทึก</v-btn>
                </div>
              </div>
            </b-col>
      </b-row>
            ...
            <b-col xl>
                        <div  class="md-layout">
                          ...
                          <v-select
                                ...
                                :item-text="item => item.user_id +' : '+ item.user_name+ ' '+ item.user_surname"
                                item-value="user_id"
                                solo
                                dense
                        ></v-select>
                        ...
                        <div  class="md-layout">
                          ...
                          v-bind:class="[Error.errorClassPwd]"
                            v-model="supplier.PASS"
                             :style="{'background': info_sup == '' ?  'rgba(0, 0, 0, 0.12)' : '#fff'}"
          ...
          <b-row style="background-color:" >
            <b-col style="background-color:">
              <div  class="md-layout">
                <div style="width: 10%;" class="head">ที่อยู่ <span style="color:red">*</span></div>
                <div style="width:80%" class="detail">
                  <input 
      ...
      <v-card   style="border-radius:14px">
        <v-card-title style="background-color:#000;" class="text-h5 ">
         <div style="color:#fff;width: 100%;" class="md-layout">
          ...
          <div style="justify-content: flex-end;display: flex;width: 20%"><span style="cursor: pointer;" class="mdi mdi-close mdi-18px"></span></div>
         </div>
        </v-card-title>
        <v-card-text  style="font-family:'Bai Jamjuree', sans-serif;padding: 24px 24px 20px; flex-direction: row;color:#000;font-size: 16px;">
            <div style="text-align: center;">คุณต้องการสร้าง<b>ผู้ใช้งานใหม่</b></div>
    ...
    >
      <v-card   style="border-radius:14px">
        <v-card-title style="background-color:#000;" class="text-h5 ">
         <div style="color:#fff;width: 100%;" class="md-layout">
          <div style="width: 80%;">บันทึกการเปลี่ยนแปลง</div>
          <div style="justify-content: flex-end;display: flex;width: 20%"><span @click="edit_save('success')" style="cursor: pointer;" class="mdi mdi-close mdi-18px"></span></div>
         </div>
        </v-card-title>
        <v-card-text  style="font-family:'Bai Jamjuree', sans-serif;padding: 24px 24px 20px; flex-direction: row;color:#000;font-size: 16px;">
          ...
          <div :style="{ width: windowSize <= 600 ? '0%' : '25%'}" style="display: flex;align-items: flex-end;"  class="right">
...
export default {
  ...
  methods: {
    ...
    OnCreate(){
      ...
      if(this.statusInput == 'admin'){
       this.$store
              .dispatch('getDataUserCreate', data)
              .then(res => {
