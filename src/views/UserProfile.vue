  ...
  <div id="user-profile-page" v-resize="onResize">
    <div class="box-1">
      ...
      >
                ...
                <div class="md-layout">
                  ...
                  <div class="detail-40">
                    <input
                      ...
                      :disabled="true"
                      v-model="this.profile.user_email"
                      class="input-style"
                    />
                    <div v-if="this.wrong.invalid_email" class="txt-wrong">
                      <span class="mdi mdi-alert-octagon"></span>Please enter a
                      valid email address
                    </div>
                  </div>
                </div>
                ...
                <div class="md-layout">
                  ...
                  <div class="detail-40">
                    <input
                      ...
                      :disabled="true"
                      v-model="this.profile.user_name"
                      class="input-style"
                    />
                  </div>
                </div>
                ...
                <div class="md-layout">
                  ...
                  <div class="detail-40">
                    <input
                      :style="{ 'background-color': '#DADADA' }"
                      :disabled="true"
                      v-model="this.profile.user_surname"
                      class="input-style"
                    />
                  </div>
                </div>
                ...
                <div class="md-layout">
                  ...
                  <div class="detail-40">
                    <input
                      :style="{ 'background-color': '#DADADA' }"
                      :disabled="true"
                      v-model="this.profile.user_company"
                      class="input-style"
                    />
                  </div>
                </div>
                ...
                <div class="md-layout">
                  ...
                  <div class="detail-40">
                    <input
                      :style="{ 'background-color': '#DADADA' }"
                      :disabled="true"
                      v-model="this.profile.user_phone"
                      class="input-style"
                    />
                  </div>
                </div>
                      ...
                      <md-input
                        ...
                        :type="
                          !this.icon_eye.confrim_new_password
                            ...
                            : 'text'
                        "
                        v-model="edit_val.confrim_new_password"
                      ></md-input>
                      <span
                ...
                >
                  ...
                  <div class="detail-40">
                    <textarea
                      :disabled="true"
                      :style="{ 'background-color': '#DADADA' }"
                      :value="this.profile.user_address"
                      style="border-radius: 8px;min-height:100px;width: 100%;padding:5px;"
                      name="w3review"
                      rows="4"
                    >
                    </textarea>
        ...
        <!-- DIALOG 2  -->
        <v-dialog v-model="dialog_save" persistent max-width="454px">
          <v-card style="border-radius: 40px;padding: 0;">
            <v-card-text style="border-radius: 40px;padding: 0;">
              <v-container
                style="display: flex;
              ...
              >
                <div class="my-layout">
                  ...
                  <div
                    style="color:#000;display: flex;justify-content: center;"
                  >
